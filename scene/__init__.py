...
class Scene:
    def __init__(self, traindata, gaussians: GaussianModel, opt: GSParams, is_sky: bool = False, is_fg: bool = False):
        ...
        self.gaussians.create_from_pcd(info.point_cloud, self.cameras_extent, is_sky=is_sky, is_fg=is_fg)
