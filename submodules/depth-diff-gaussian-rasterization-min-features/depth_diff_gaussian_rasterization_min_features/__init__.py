...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, language_feature, depth, median_depth, final_opacity, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, language_feature,radii, depth, median_depth, final_opacity

    @staticmethod
    def backward(ctx, grad_out_color, grad_out_language_feature, grad_radii, grad_depth, grad_median_depth, grad_final_opacity):
